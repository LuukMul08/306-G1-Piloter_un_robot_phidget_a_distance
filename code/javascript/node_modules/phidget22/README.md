...
Supported USB Phidgets will list USB Stack as `'PHIDUSB'` in the Specifications table on their product page at  [www.phidgets.com](https://www.phidgets.com). All VINT Phidgets are supported when attached to a supported USB VINT Hub.
